...
/*
		 ...
		 Los recipientes se clasifican en el orden que llegan y se asignan a un estante.
		 	...
		 	Si la fruta/verdura el recipiente es tipo 2,3 estante3
		 
		 Crear 5 recipientes con fruta/verdutra
		 
		 Crear camion (cola recipientes)
		 crear estante1 (cola recipiente)
		 crear estante2 (cola recipiente)
		 crear estante3 (cola recipiente)
